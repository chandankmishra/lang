...
def replace_file(filename):
    ...
    inplace_change(filename, "zph_blk", "zephyr_blk")
    ...
    inplace_change(filename, "\"ZPH ", "\"ZEPHYR ")
    inplace_change(filename, " ZPH ", " ZEPHYR ")
    inplace_change(filename, " ZPF_", " ZEPHYR_")
    inplace_change(filename, " ZPH[", " ZEPHYR[")
    inplace_change(filename, "[ZPH_", "[ZEPHYR_")
    inplace_change(filename, "\"ZPH[", "\"ZEPHYR[")
    inplace_change(filename, "/zph", "/zephyr")
    inplace_change(filename, "_ZPH(", "_ZEPHYR(")
    inplace_change(filename, "_ZPH_", "_ZEPHYR_")
    inplace_change(filename, "_zph(", "_zephyr(")
    inplace_change(filename, "_zph_", "_zephyr_")
    inplace_change(filename, "\"zph.", "\"zephyr.")
    inplace_change(filename, " ZPH_", " ZEPHYR_")
    ...
    inplace_change(filename, "(zph_", "(zephyr_")
    inplace_change(filename, "(zph ", "(zephyr ")
    inplace_change(filename, "ZPHCHIP", "ZEPHYR")
    inplace_change(filename, "zphchip", "zephyr")
    inplace_change(filename, "(ZPHCHIP", "(ZEPHYR")
    inplace_change(filename, "(zphchip", "(zephyr")
